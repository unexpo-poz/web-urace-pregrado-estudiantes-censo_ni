...
<select name="depend_p_eS" id="depend_p_e_S_1" class="datospf" onChange="parroquia_naci(ent_fed_S_1.value, this.value, tot_raz_v.value, depend_p_e.value, estadoBD.value);">
