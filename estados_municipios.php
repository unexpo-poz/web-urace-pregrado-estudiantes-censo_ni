...
<select name="codigo_mS" id="codigo_m_S_1" class="datospf" onChange="parroquia_lic(codigoe_S_1.value, this.value, codigo_pquia.value, codigo_m.value, estadoBD.value);">
