...
$tProceso			= 'Censo para Nuevo Ingreso Lapso 2024-1';
...
//$fecha_i = '04-07-2022'; // Fecha de inicio del censo (DD-MM-AAAA). FECHA ANTERIOR
//$fecha_i = '07-08-2018'; // Fecha de inicio del censo (DD-MM-AAAA).
...
//Unidad Tributaria:
$unidadTributaria	= 130; //SUELDO MINIMO ACTUAL
